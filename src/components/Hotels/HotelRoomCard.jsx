    ...
    <div className="w-full mb-4">
      <div className="w-[95%] rounded-xl mx-auto shadow-lg">
        ...
        <div className="p-4">
          ...
          <div className="font-medium sm:font-semibold text-xl mb-3">
            {room.name ? room.name : "Room Name is null"}
          </div>
          <div className="flex flex-wrap items-center gap-4 mb-5 py-4 border-t border-b border-solid border-[#d3d3d3]">
            <div className="flex items-center gap-2 text-base sm:text-base rounded-lg p-2 font-normal border border-solid border-[#dfdfdf] bg-lightBackground">
