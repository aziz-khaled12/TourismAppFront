...
const ServicesSwiper = ({ other = "" }) => {
  ...
  const NavbarServices = [
    ...
    },
    {
      ...
      selectedIcon: <RiMapLine className="text-2xl" />,
      name: "Map",
      link: "/map",
    },
  ];
  ...
  return (
    <>
      <div className="sm:mt-4 sm:pt-0 pt-1 w-full ">
        <Divider className="sm:block hidden"></Divider>
        <div
          className={`w-full flex relative items-center justify-center py-2 ${other} `}
        >
          {!isAtStart && (
